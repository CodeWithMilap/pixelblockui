        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="relative flex items-center justify-between h-16 md:h-20">
            ...
            <div className="hidden md:block">
              <div className="flex space-x-4">
                <Link
                  href="#"
                  className="text-base font-medium text-zinc-700 hover:text-zinc-950 dark:text-zinc-400 dark:hover:text-zinc-200"
                >
                  About
                </Link>
                <Link
          ...
          >
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              <Link
                href="#"
                className="block px-3 py-2 rounded-md text-base font-medium text-zinc-700 hover:text-zinc-950 hover:bg-zinc-100 dark:text-zinc-400 dark:hover:text-zinc-200"
              >
                About
              </Link>
              <Link
          ...
          <div className="mx-auto max-w-2xl py-32">
            <div className="text-center">
              ...
              <p className="mt-6 text-lg leading-8 ">
                ...
                tool you need to speed up your design process.
              </p>
