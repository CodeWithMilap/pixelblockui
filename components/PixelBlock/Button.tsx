    ...
    const getColorClasses = (color: Color, variant: ButtonVariant) => {
      const colorMap = {
        primary: {
          ...
          link: "text-primary-600 hover:underline p-0 h-auto focus-visible:ring-primary-500",
          shadow: "bg-primary-600 text-white shadow-lg hover:shadow-xl hover:bg-primary-700 focus-visible:ring-primary-500",
          text: "text-primary-600 hover:bg-primary-50 focus-visible:ring-primary-500",
        },
        secondary: {
          solid: "bg-secondary-600 text-white hover:bg-secondary-700 focus-visible:ring-secondary-500",
          outline: "border-2 border-secondary-600 text-secondary-600 hover:bg-secondary-50 focus-visible:ring-secondary-500",
          ghost: "text-secondary-600 hover:bg-secondary-50 focus-visible:ring-secondary-500",
          link: "text-secondary-600 hover:underline p-0 h-auto focus-visible:ring-secondary-500",
          shadow: "bg-secondary-600 text-white shadow-lg hover:shadow-xl hover:bg-secondary-700 focus-visible:ring-secondary-500",
          text: "text-secondary-600 hover:bg-secondary-50 focus-visible:ring-secondary-500",
        },
        info: {
