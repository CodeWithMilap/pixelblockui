...
<Tabs defaultValue="preview">
  ...
  <TabsContent value="preview">
    <div className="bg-white dark:bg-zinc-900/10 rounded-lg border dark:border-white/10 shadow-sm h-full w-full py-4 px-2">
      <div className="max-w-full py-4 px-2 w-full h-full overflow-x-auto grid grid-col-5 gap-4">
        <div className="flex gap-6 flex-wrap">
          <Button color="primary" icon={<IconComponent />}>With Icon</Button>
          <Button variant="outline" color="secondary" icon={<IconComponent />}>Outline Icon</Button>
        </div>
      </div>
    </div>
  </TabsContent>
  <TabsContent value="code">
    ```jsx
    import { IconComponent } from 'your-icon-library';
...
<Tabs defaultValue="preview">
  ...
  <TabsContent value="preview">
    <div className="bg-white dark:bg-zinc-900/10 rounded-lg border dark:border-white/10 shadow-sm h-full w-full py-4 px-2">
      <div className="max-w-full py-4 px-2 w-full h-full overflow-x-auto grid grid-col-5 gap-4">
        <div className="flex gap-6 flex-wrap">
          <Button color="primary" icon={<IconComponent />} />
          <Button variant="outline" color="secondary" icon={<IconComponent />} />
        </div>
      </div>
    </div>
  </TabsContent>
...
<Tabs defaultValue="preview">
  ...
  <TabsContent value="preview">
    <div className="bg-white dark:bg-zinc-900/10 rounded-lg border dark:border-white/10 shadow-sm h-full w-full py-4 px-2">
      <div className="max-w-full py-4 px-2 w-full h-full overflow-x-auto grid grid-col-5 gap-4">
        <div className="flex gap-6 flex-wrap">
          <Button color="primary" icon={<LoadingIcon />} >Loading</Button>
        </div>
      </div>
    </div>
  </TabsContent>
