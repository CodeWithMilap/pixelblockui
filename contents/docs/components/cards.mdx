...
In this example, the card focuses on presenting a testimonial or quote from an author, without an image or read-more link.
...
This example demonstrates a card with an image and tags displayed at the bottom of the card.
    ...
    <div className="bg-white dark:bg-zinc-900/10 rounded-lg border dark:border-white/10 shadow-sm h-full w-full py-4 px-2 not-prose">
      <Cards
        blok={{
          ...
          description:
            "Explore the top web design trends of 2020, including user experience best practices and the rise of dark mode.",
...
This example shows how to render
 ...
 multiple cards, allowing for easy display of content in grids or lists.
