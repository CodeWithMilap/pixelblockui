...
const AnimatedSvg = ({ className }: any) => (
  ...
  >
    ...
    <path
      d="M10,21v-13c0-.552285-.447715-1-1-1h-5c-.552285,0-1,.447715-1,1v12c0,.552285.447715,1,1,1h12c.552285,0,1-.447715,1-1v-5c0-.552285-.447715-1-1-1h-13"
      fill="none"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
...
export function IconDownload({ className }: any) {
  return (
    <svg
      className={className}
      fill="none"
...
export function IconColor({ className }: any) {
  return (
    <svg
      viewBox="0 0 14 14"
      role="img"
